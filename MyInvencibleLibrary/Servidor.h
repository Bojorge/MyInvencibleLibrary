...
public:
/**
* @brief dependiendo de la longitud de lo que se recibe, guarda una imagen o lee los datos consultados
 **/
bool leerImagen(int sockfd){
    ...
    //si recibe el codigo de tres digitos lee los datos asociados a ese codigo
    if(o.size()==4){
        cod+=o[0];
        cod+=o[1];
        cod+=o[2];
    ...
    //si lo que recibe es de mayor longitud, son los datos (pixeles) de la imagen
    if(o.size()>4) {
...
/**
* @brief reinicia la conexion
 **/
int reiniciar(){

    // se crea el socket y se  verifica
    ...
    // Enlace de socket recién creado a una determinada IP y verificación
